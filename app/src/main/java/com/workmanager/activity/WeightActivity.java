...
public class WeightActivity extends BaseNFCActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNFcTitle.setText("計量場リスト");
        dataList=TaskFunction.win();
    ...
    private void search() {
        ...
        mSearchListViewAdapter = new SearchListViewAdapter(WeightActivity.this, searchR, searchContent);
        ...
        mBindingList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    GetDataBase.spfE.setiWeightID(searchR.get(i).getThingid());
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (GetDataBase.spfE.getStatus().equals("2")){
                                ...
                                if (TaskManageFunction.taskSend("2",1)==0){
                                    msg.what=0;
                                }else {
                                    msg.what=-1;
                                }
    ...
    private void dialog(){
        new ConfirmDialog(WeightActivity.this, true)
                .setTtitle("確認")
                .setMessage("更新失败。")
